...
func (o *ClusterUninstaller) listFilestores() ([]cloudResource, error) {
...
func (o *ClusterUninstaller) deleteFilestore(item cloudResource) error {
...
func (o *ClusterUninstaller) destroyFilestores() error {
	found, err := o.listFilestores()
	if err != nil {
		return err
	}
	items := o.insertPendingItems("filestore", found)
	for _, item := range items {
		err := o.deleteFilestore(item)
		if err != nil {
